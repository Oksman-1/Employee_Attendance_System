...
public class UpdateLeaveRecordDtoValidator : AbstractValidator<UpdateLeaveRecordDto>
{
   public UpdateLeaveRecordDtoValidator()
    {
        RuleFor(x => x.Id)
            .GreaterThan(0).WithMessage("LeaveRecord Id must be greater than 0.");
